...
**Description:**  
Calls a shortcut entitled “Post to Write.as Blog (macOS)” with the entire contents of the [](../snippets/draft).
...
`simplenote://new?content=[](../snippets/draft)&tag=drafts`
