...
`tg://msg?text=[draft](../snippets/draft)&to=`
...
**Description:**  
Calls a shortcut entitled “Post to Write.as Blog (macOS)” with the entire contents of the [draft](../snippets/draft).
...
`simplenote://new?content=[draft](../snippets/draft)&tag=drafts`
